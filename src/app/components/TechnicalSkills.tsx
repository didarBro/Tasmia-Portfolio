...
const TechnicalSkills = () => {
  ...
  // Static skills data with high-quality online images
  const staticSkillsData: TSkills[] = [
    { _id: "1", name: "Cypress", level: 85, img: "https://cdn.worldvectorlogo.com/logos/cypress-io-1.svg" },
    { _id: "2", name: "Playwright", level: 80, img: "https://cdn.worldvectorlogo.com/logos/playwright.svg" },
    { _id: "3", name: "Manual Testing", level: 90, img: "https://cdn-icons-png.flaticon.com/512/1995/1995515.png" },
    {
      _id: "4",
    ...
    { _id: "5", name: "JavaScript", level: 75, img: "https://cdn.worldvectorlogo.com/logos/logo-javascript.svg" },
    { _id: "6", name: "Python", level: 70, img: "https://cdn.worldvectorlogo.com/logos/python-5.svg" },
    { _id: "7", name: "Postman", level: 85, img: "https://cdn.worldvectorlogo.com/logos/postman.svg" },
    { _id: "8", name: "JMeter", level: 75, img: "https://jmeter.apache.org/images/jmeter_square.svg" },
    { _id: "9", name: "Jira", level: 90, img: "https://cdn.worldvectorlogo.com/logos/jira-1.svg" },
    { _id: "10", name: "TestRail", level: 80, img: "https://cdn.worldvectorlogo.com/logos/testrail.svg" },
    {
      _id: "11",
      name: "API Testing",
      level: 85,
    ...
    { _id: "12", name: "Java", level: 65, img: "https://cdn.worldvectorlogo.com/logos/java-4.svg" },
    { _id: "13", name: "MySQL", level: 70, img: "https://cdn.worldvectorlogo.com/logos/mysql-6.svg" },
    { _id: "14", name: "PostgreSQL", level: 72, img: "https://cdn.worldvectorlogo.com/logos/postgresql.svg" },
    { _id: "15", name: "GitHub", level: 85, img: "https://cdn.worldvectorlogo.com/logos/github-icon-1.svg" },
    { _id: "16", name: "OWASP ZAP", level: 60, img: "https://www.zaproxy.org/images/zap-icon.png" },
    {
      _id: "17",
      name: "Performance Testing",
      level: 75,
      img: "https://cdn-icons-png.flaticon.com/512/3067/3067256.png",
    },
    { _id: "18", name: "JEST", level: 70, img: "https://cdn.worldvectorlogo.com/logos/jest-2.svg" },
    { _id: "19", name: "Pytest", level: 68, img: "https://docs.pytest.org/en/stable/_static/pytest_logo_curves.svg" },
    {
      _id: "20",
      name: "Load Testing",
      level: 78,
  ...
  useEffect(() => {
    ...
    skillsContainer.addEventListener('wheel', handleScroll, { passive: false });
    skillsContainer.addEventListener('touchstart', handleTouchStart);
    skillsContainer.addEventListener('touchmove', handleTouchMove, { passive: false });

    return () => {
      if (skillsContainer) {
        skillsContainer.removeEventListener('wheel', handleScroll);
  ...
  return (
    <div
      id="skills"
      className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 overflow-hidden relative"
    >
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gray-800/80 backdrop-blur-lg rounded-xl overflow-hidden border border-gray-700/50 group-hover:border-green-500/50 transition-all duration-300 h-full flex flex-col">
        {/* Professional background pattern for each card */}
